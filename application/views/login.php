...
<body>
	...
	<div id="container">
		...
		<div id="login_form">
			...
			<div id="submit_button"><?php echo form_submit('loginButton','Entrar'); ?> </div>
		</div>
	</div>
	<?php echo form_close(); ?><h1>Aplicacion de Punto de Venta <?php echo $this->config->item('application_version'); ?></h1>
</body>
</html>
